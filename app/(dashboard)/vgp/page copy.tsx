// components/vgp/VGPDashboard.tsx
'use client';
        ...
        <div className="max-w-7xl mx-auto p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="bg-white rounded-lg shadow p-6 border-2 border-gray-200">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                        Sous surveillance VGP
                    </p>
                </div>
            </div>

            {/* Overdue Inspections - Critical Alert */}
            {overdue.length > 0 && (
                    ...
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-red-900">
                                ⚠️ Inspections En Retard - Risque de Non-Conformité
                            </h2>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex-1">
                                            ...
                                            <div className="flex items-center gap-4 mt-2 text-sm text-gray-600">
                                                ...
                                                <span>Catégorie: {schedule.assets.category}</span>
                                                <span>Localisation: {schedule.assets.location || 'N/A'}</span>
                                            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-4">
                    Inspections à Venir (30 Prochains Jours)
                </h2>
                    ...
                    <div className="space-y-3">
                        {upcoming.map((schedule) => {
                            ...
                            return (
                                <div
                                    key={schedule.id}
                                    className={`rounded-lg p-4 border-2 ${isUrgent
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className={`px-2 py-1 text-xs font-semibold rounded-full ${isUrgent
                                            ...
                                            <div className="mt-2 text-sm font-medium">
                                                Date prévue: {formatDate(schedule.next_due_date)}
                                            </div>
                                        </div>
                                        <button
                                            onClick={() => window.location.href = `/vgp/inspection/${schedule.id}`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-6 border border-blue-200">
                    ...
                    <p className="text-xs text-blue-700">
                        Amendes évitées grâce à la conformité VGP
                    </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-6 border border-green-200">
                    ...
                    <p className="text-xs text-green-700">
                        Réduction du temps de gestion des inspections
                    </p>
                </div>
