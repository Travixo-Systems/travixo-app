...
const AGENCIES: Agency[] = [
  ...
  // -----------------------------------------------------------------------
  {
    name: 'LocaMat Ile-de-France',
    slug: 'locamat-idf',
    locations: ['Dépôt Gennevilliers (92)', 'Dépôt Rungis (94)', 'Dépôt Marne-la-Vallée (77)'],
    categories: [
      { name: 'Nacelle' },
    ...
    assets: [
      // Gennevilliers depot
      { name: 'Nacelle articulée Haulotte HA20 RTJ Pro', serial: 'IDF-NAC-001', category: 'Nacelle', status: 'available', location: 'Dépôt Gennevilliers (92)' },
      { name: 'Nacelle ciseaux JLG 4394RT', serial: 'IDF-NAC-002', category: 'Nacelle', status: 'in_use', location: 'Chantier La Defense T1' },
      { name: 'Nacelle télescopique JLG 860SJ', serial: 'IDF-NAC-003', category: 'Nacelle', status: 'available', location: 'Dépôt Gennevilliers (92)' },
      { name: 'Chariot élévateur Toyota 8FD30', serial: 'IDF-CHA-001', category: 'Chariot élévateur', status: 'available', location: 'Dépôt Gennevilliers (92)' },
      { name: 'Chariot télescopique Manitou MHT 10130', serial: 'IDF-CHA-002', category: 'Chariot élévateur', status: 'in_use', location: 'Chantier Saclay CEA' },
      { name: 'Groupe électrogène Atlas Copco QAS 150', serial: 'IDF-GE-001', category: 'Groupe électrogène', status: 'available', location: 'Dépôt Gennevilliers (92)' },

      // Rungis depot
      { name: 'Mini-pelle Kubota KX080-4a', serial: 'IDF-ENG-001', category: 'Engin de chantier', status: 'available', location: 'Dépôt Rungis (94)' },
      { name: 'Chargeuse Bobcat S770', serial: 'IDF-ENG-002', category: 'Engin de chantier', status: 'in_use', location: 'Chantier Orly Terminal 4' },
      { name: 'Nacelle articulée Genie Z-60/37 FE', serial: 'IDF-NAC-004', category: 'Nacelle', status: 'maintenance', location: 'Atelier Rungis' },
      { name: 'Chariot élévateur Linde H50D', serial: 'IDF-CHA-003', category: 'Chariot élévateur', status: 'available', location: 'Dépôt Rungis (94)' },

      // Marne-la-Vallée depot
      { name: 'Nacelle articulée Haulotte HA16 RTJ', serial: 'IDF-NAC-005', category: 'Nacelle', status: 'available', location: 'Dépôt Marne-la-Vallée (77)' },
      { name: 'Pelle sur chenilles Caterpillar 320', serial: 'IDF-ENG-003', category: 'Engin de chantier', status: 'in_use', location: 'Chantier Val d\'Europe' },
      { name: 'Groupe électrogène SDMO J200', serial: 'IDF-GE-002', category: 'Groupe électrogène', status: 'available', location: 'Dépôt Marne-la-Vallée (77)' },
      { name: 'Compacteur Bomag BW 120 AD-5', serial: 'IDF-ENG-004', category: 'Engin de chantier', status: 'available', location: 'Dépôt Marne-la-Vallée (77)' },
    ],
    vgpSchedules: [
      { assetSerial: 'IDF-NAC-001', intervalMonths: 6, daysOffset: 22 },
      { assetSerial: 'IDF-NAC-002', intervalMonths: 6, daysOffset: -5 },  // overdue
  ...
  // -----------------------------------------------------------------------
  {
    name: 'Alp\'Loc Equipements',
    slug: 'alploc-rhonealpes',
    locations: ['Dépôt Lyon-Venissieux (69)', 'Dépôt Grenoble-Echirolles (38)'],
    categories: [
      { name: 'Nacelle' },
      { name: 'Chariot élévateur' },
      { name: 'Engin de chantier' },
    ...
    assets: [
      // Lyon depot
      { name: 'Nacelle articulée Haulotte HA16 RTJ', serial: 'ALP-NAC-001', category: 'Nacelle', status: 'available', location: 'Dépôt Lyon-Venissieux (69)' },
      { name: 'Nacelle ciseaux Skyjack SJ6832RT', serial: 'ALP-NAC-002', category: 'Nacelle', status: 'in_use', location: 'Chantier Part-Dieu Tour Incity' },
      { name: 'Chariot élévateur Toyota 8FD25', serial: 'ALP-CHA-001', category: 'Chariot élévateur', status: 'available', location: 'Dépôt Lyon-Venissieux (69)' },
      { name: 'Chariot télescopique Manitou MT1440', serial: 'ALP-CHA-002', category: 'Chariot élévateur', status: 'maintenance', location: 'Atelier Lyon' },
      { name: 'Mini-pelle Volvo ECR25D', serial: 'ALP-ENG-001', category: 'Engin de chantier', status: 'available', location: 'Dépôt Lyon-Venissieux (69)' },
      { name: 'Compresseur Atlas Copco XAS 97', serial: 'ALP-ENG-002', category: 'Engin de chantier', status: 'in_use', location: 'Chantier Confluence Lot B' },

      // Grenoble depot
      { name: 'Nacelle articulée Genie Z-45 FE', serial: 'ALP-NAC-003', category: 'Nacelle', status: 'available', location: 'Dépôt Grenoble-Echirolles (38)' },
      { name: 'Chariot élévateur Hyster H3.0FT', serial: 'ALP-CHA-003', category: 'Chariot élévateur', status: 'in_use', location: 'Entrepôt Alpexpo' },
      { name: 'Pelle sur pneus Liebherr A 918', serial: 'ALP-ENG-003', category: 'Engin de chantier', status: 'available', location: 'Dépôt Grenoble-Echirolles (38)' },
      { name: 'Dumper Wacker Neuson DW60', serial: 'ALP-ENG-004', category: 'Engin de chantier', status: 'available', location: 'Dépôt Grenoble-Echirolles (38)' },
    ],
    vgpSchedules: [
      { assetSerial: 'ALP-NAC-001', intervalMonths: 6, daysOffset: 30 },
      { assetSerial: 'ALP-NAC-002', intervalMonths: 6, daysOffset: -3 },  // overdue
  ...
  // -----------------------------------------------------------------------
  {
    name: 'SudLoc Services',
    slug: 'sudloc-sudouest',
    locations: ['Dépôt Toulouse-Colomiers (31)', 'Dépôt Bordeaux-Merignac (33)', 'Dépôt Pau-Lescar (64)'],
    categories: [
      { name: 'Nacelle' },
      { name: 'Chariot élévateur' },
      { name: 'Engin de chantier' },
    ...
    assets: [
      // Toulouse depot
      { name: 'Nacelle articulée Haulotte HA20 RTJ', serial: 'SUD-NAC-001', category: 'Nacelle', status: 'available', location: 'Dépôt Toulouse-Colomiers (31)' },
      { name: 'Nacelle ciseaux Holland Lift N-195EL16', serial: 'SUD-NAC-002', category: 'Nacelle', status: 'in_use', location: 'Chantier Airbus A321XLR (Blagnac)' },
      { name: 'Chariot élévateur Still RX70-30', serial: 'SUD-CHA-001', category: 'Chariot élévateur', status: 'available', location: 'Dépôt Toulouse-Colomiers (31)' },
      { name: 'Mini-pelle Yanmar ViO57-6B', serial: 'SUD-ENG-001', category: 'Engin de chantier', status: 'in_use', location: 'Chantier Metro Ligne 3' },
      { name: 'Echafaudage roulant Layher SpeedyScaf', serial: 'SUD-DIV-001', category: 'Materiel divers', status: 'available', location: 'Dépôt Toulouse-Colomiers (31)' },

      // Bordeaux depot
      { name: 'Nacelle articulée JLG 450AJ', serial: 'SUD-NAC-003', category: 'Nacelle', status: 'available', location: 'Dépôt Bordeaux-Merignac (33)' },
      { name: 'Chariot télescopique Manitou MT 625', serial: 'SUD-CHA-002', category: 'Chariot élévateur', status: 'in_use', location: 'Chantier Euratlantique Lot 4' },
      { name: 'Chargeuse Bobcat S550', serial: 'SUD-ENG-002', category: 'Engin de chantier', status: 'available', location: 'Dépôt Bordeaux-Merignac (33)' },
      { name: 'Groupe électrogène SDMO J88', serial: 'SUD-DIV-002', category: 'Materiel divers', status: 'available', location: 'Dépôt Bordeaux-Merignac (33)' },

      // Pau depot
      { name: 'Nacelle ciseaux Haulotte Compact 12', serial: 'SUD-NAC-004', category: 'Nacelle', status: 'available', location: 'Dépôt Pau-Lescar (64)' },
      { name: 'Chariot élévateur Toyota 8FD20', serial: 'SUD-CHA-003', category: 'Chariot élévateur', status: 'available', location: 'Dépôt Pau-Lescar (64)' },
      { name: 'Plaque vibrante Bomag BPR 35/60', serial: 'SUD-ENG-003', category: 'Engin de chantier', status: 'available', location: 'Dépôt Pau-Lescar (64)' },
    ],
    vgpSchedules: [
      { assetSerial: 'SUD-NAC-001', intervalMonths: 6, daysOffset: 18 },
      { assetSerial: 'SUD-NAC-002', intervalMonths: 6, daysOffset: -8 },  // overdue
...
>>>>>>> 9a50244 (i18n: French the public scan page, add import and legal-reference keys)
