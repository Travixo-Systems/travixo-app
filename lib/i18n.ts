...
export const translations = {
  ...
  assetDetail: {
    backToAssets: { en: "Back to Fleet", fr: "Retour au Parc" },
    details: { en: "DETAILS", fr: "DÉTAILS" },
    modify: { en: "Edit →", fr: "Modifier →" },
    status: { en: "Status", fr: "Statut" },
    purchaseDate: { en: "Purchase Date", fr: "Date d'achat" },
    purchasePrice: { en: "Purchase Price", fr: "Prix d'achat" },
    currentValue: { en: "Current Value", fr: "Valeur actuelle" },
    description: { en: "Description", fr: "Description" },
    noDescription: { en: "No description", fr: "Aucune description" },
    vgpCompliance: { en: "VGP COMPLIANCE", fr: "CONFORMITÉ VGP" },
    vgpInterval: { en: "Inspection interval", fr: "Intervalle d'inspection" },
    vgpMonths: { en: "months", fr: "mois" },
    vgpLastInspection: { en: "Last inspection", fr: "Dernière inspection" },
    vgpNextDue: { en: "Next due", fr: "Prochaine échéance" },
    vgpDaysRemaining: { en: "days remaining", fr: "jours restants" },
    vgpDaysOverdue: { en: "days overdue", fr: "jours de retard" },
    vgpNone: { en: "No VGP monitoring configured", fr: "Aucune surveillance VGP configurée" },
    vgpConfigure: { en: "Configure →", fr: "Configurer →" },
    inspectionHistory: { en: "INSPECTION HISTORY", fr: "HISTORIQUE DES INSPECTIONS" },
    newInspection: { en: "New inspection →", fr: "Nouvelle inspection →" },
    inspectionDate: { en: "Date", fr: "Date" },
    inspector: { en: "Inspector", fr: "Inspecteur" },
    company: { en: "Company", fr: "Entreprise" },
    result: { en: "Result", fr: "Résultat" },
    certificate: { en: "Certificate", fr: "Certificat" },
    resultPassed: { en: "Passed", fr: "Conforme" },
    resultConditional: { en: "Conditional", fr: "Conditionnel" },
    resultFailed: { en: "Failed", fr: "Non conforme" },
    noInspections: { en: "No inspections recorded", fr: "Aucune inspection enregistrée" },
    rentalHistory: { en: "RENTAL HISTORY", fr: "HISTORIQUE DES LOCATIONS" },
    rentalClient: { en: "Client", fr: "Client" },
    rentalStart: { en: "Start", fr: "Début" },
    rentalEnd: { en: "End", fr: "Fin" },
    rentalStatus: { en: "Status", fr: "Statut" },
    rentalActive: { en: "Active", fr: "Actif" },
    rentalReturned: { en: "Returned", fr: "Retourné" },
    noRentals: { en: "No rentals recorded", fr: "Aucune location enregistrée" },
    notAvailable: { en: "N/A", fr: "N/D" },
    downloadQr: { en: "Download QR", fr: "Télécharger QR" },
  },
  vgpRentalContext: {
    currentlyRented: { en: "Equipment currently rented out", fr: "Équipement actuellement en location" },
    client: { en: "Client", fr: "Client" },
    expectedReturn: { en: "Expected return", fr: "Retour prévu" },
    afterVgpDue: { en: "after VGP due date", fr: "après l'échéance VGP" },
    beforeVgpDue: { en: "before VGP due date", fr: "avant l'échéance VGP" },
    noActionRequired: { en: "No action required.", fr: "Aucune action requise." },
    recallEquipment: { en: "Recall equipment", fr: "Rappeler l'équipement" },
    ...
    rentedAt: { en: "Currently at", fr: "Actuellement chez" },
  },
  vgpInspection: {
    loading: { en: "Loading...", fr: "Chargement..." },
    pageTitle: { en: "Record a VGP Inspection", fr: "Enregistrer une Inspection VGP" },
    pageSubtitle: { en: "Recording inspection for", fr: "Enregistrement de l'inspection pour" },
    readOnlyTitle: { en: "Record a VGP Inspection", fr: "Enregistrer une Inspection VGP" },
    readOnlyMessage: {
      en: "Recording inspections is not available in read-only mode. Upgrade to Professional plan to record new inspections.",
      fr: "L'enregistrement d'inspections n'est pas disponible en mode lecture seule. Passez au plan Professionnel pour enregistrer de nouvelles inspections.",
    },
    backToVgp: { en: "Back to VGP dashboard", fr: "Retour au tableau VGP" },
    equipmentInfo: { en: "Equipment Information", fr: "Informations sur l'Équipement" },
    ...
    inspectionDetails: { en: "Inspection Details", fr: "Détails de l'Inspection" },
    inspectionDate: { en: "Inspection Date", fr: "Date d'Inspection" },
    inspectorName: { en: "Inspector Name", fr: "Nom de l'Inspecteur" },
    inspectorNamePlaceholder: { en: "John Smith", fr: "Jean Dupont" },
    inspectionBody: { en: "Inspection Body", fr: "Organisme de Contrôle" },
    inspectionBodyPlaceholder: { en: "Bureau Veritas, DEKRA, Apave...", fr: "Bureau Veritas, DEKRA, Apave..." },
    certNumber: { en: "Certificate Number", fr: "Numéro de Certificat" },
    certNumberPlaceholder: { en: "VGP-2025-12345", fr: "VGP-2025-12345" },
    result: { en: "Inspection Result", fr: "Résultat de l'Inspection" },
    resultPassed: { en: "Compliant", fr: "Conforme" },
    resultPassedDesc: { en: "Next inspection: per interval", fr: "Prochaine inspection : selon l'intervalle" },
    resultConditional: { en: "Conditional", fr: "Conditionnel" },
    ...
    chooseFile: { en: "Choose a file", fr: "Choisir un fichier" },
    orDragDrop: { en: "or drag and drop", fr: "ou glissez-déposez" },
    ...
    submitting: { en: "Saving...", fr: "Enregistrement..." },
    uploadingProgress: { en: "Uploading...", fr: "Téléchargement..." },
    errorLoadSchedule: { en: "Failed to load schedule", fr: "Échec du chargement du calendrier" },
    errorRequiredFields: { en: "Please fill in all required fields", fr: "Veuillez remplir tous les champs obligatoires" },
    errorCertRequired: {
      en: "The VGP certificate is required for DREETS compliance.\n\nWithout an official certificate, the inspection does not comply with French regulations (Article R4323-23) and your equipment remains exposed to fines.",
      fr: "Le certificat VGP est obligatoire pour la conformité DREETS.\n\nSans certificat officiel, l'inspection n'est pas conforme à la réglementation française (Article R4323-23) et votre équipement reste exposé aux amendes.",
    },
    errorUploadFailed: { en: "Certificate upload failed", fr: "Échec du téléchargement du certificat" },
    errorSubmitFailed: { en: "Failed to save inspection", fr: "Échec de l'enregistrement" },
    errorUpload: { en: "Upload error:", fr: "Erreur de téléchargement:" },
