# TraviXO Documentation

## Quick Links
- [Project Context](context.md) - What TraviXO is and why it exists
- [Product Roadmap](roadmap.md) - 12-month feature timeline
- [Design System](charte_graphique.md) - UI/UX guidelines
